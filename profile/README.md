...
<img src="https://raw.githubusercontent.com/bajigurxyz/bajigur/main/docs/media/landing.png" alt="The Bajigur landing page" width="880" />
...
<div align="center">
<img src="https://raw.githubusercontent.com/bajigurxyz/bajigur/main/docs/media/prompt.png" alt="A prompt page showing the creator's ENS name, a price in both USDC and HBAR, and the Hedera account the payment goes to" width="880" />
<br/>
...
<sub>Implementation: [`apps/api/src/x402.ts`](https://github.com/bajigurxyz/bajigur/blob/main/apps/api/src/x402.ts) for the resource server,
[`apps/mcp/src/pay.ts`](https://github.com/bajigurxyz/bajigur/blob/main/apps/mcp/src/pay.ts) for the client side.</sub>
...
<sub>Implementation: [`contracts/src/BajigurRegistrar.sol`](https://github.com/bajigurxyz/bajigur/blob/main/contracts/src/BajigurRegistrar.sol),
[`apps/api/src/ens.ts`](https://github.com/bajigurxyz/bajigur/blob/main/apps/api/src/ens.ts).</sub>
...
<sub>Implementation: [`apps/api/src/agent.ts`](https://github.com/bajigurxyz/bajigur/blob/main/apps/api/src/agent.ts) for signing and the caps,
[`apps/web/src/lib/useWalletAccess.ts`](https://github.com/bajigurxyz/bajigur/blob/main/apps/web/src/lib/useWalletAccess.ts) for granting the signer.</sub>
...
| **6** | **Verify the lot** | [`docs/verify.md`](https://github.com/bajigurxyz/bajigur/blob/main/docs/verify.md) is a list of copy-and-paste commands that check every claim on this page against Hedera and Sepolia directly. |
...
|---|---|---|
| **[`apps/api`](https://github.com/bajigurxyz/bajigur/tree/main/apps/api)** | Bun + Hono. The x402 resource server, publishing, name claiming, buyer lists, licences, creator reputation. | `bun run test` in `apps/api`, **36 passing** |
| **[`apps/mcp`](https://github.com/bajigurxyz/bajigur/tree/main/apps/mcp)** | The same service as three MCP tools, with the x402 client. Hosted over Streamable HTTP with OAuth, or local over stdio. | **14 passing** |
| **[`apps/web`](https://github.com/bajigurxyz/bajigur/tree/main/apps/web)** | Next.js 16. Sign-in, wallet setup, name claiming, purchases, publishing, licences. | **45 passing** |
| **[`apps/landingpage`](https://github.com/bajigurxyz/bajigur/tree/main/apps/landingpage)** | Next.js 16. The marketing site and the MCP documentation. | **24 passing** |
| **[`contracts`](https://github.com/bajigurxyz/bajigur/tree/main/contracts)** | Foundry. `PromptRegistry` on Hedera, `BajigurRegistrar` on Sepolia, the ERC-8004 registration script. | `forge test`, **15 passing**, [CI green](https://github.com/bajigurxyz/bajigur/actions/runs/34689754624) |
| **[`packages/core`](https://github.com/bajigurxyz/bajigur/tree/main/packages/core)** | Shared types and utilities. Apps never import from each other. | **3 passing** |
...
[Live App](https://app.bajigur.xyz) · [MCP Server](https://bajigur.xyz/mcp) ·
[API](https://api.bajigur.xyz/prompts) · [Verify every claim](https://github.com/bajigurxyz/bajigur/blob/main/docs/verify.md)
